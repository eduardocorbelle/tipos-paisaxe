...
# *Ventá circular, diámetros de 250 e 2000 m (resolución 25 m/píxel)
p.sig.grid -c input=cubertas size=80 shift=1 method=coocurence histograms=Tmp/GrellaCubertasA
...
p.sig.points -c input=cubertas coorfile=Escenas/escenasCuberta.txt size=80 method=coocurence histograms=Tmp/escenasCubertaA.his
...
r.out.gdal in=ClaseCuberta2 out=ResultadosIntermedios/PatronCubertas_2000-250m_medias.img format=HFA
